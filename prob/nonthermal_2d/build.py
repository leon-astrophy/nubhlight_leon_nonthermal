...
bhl.config.set_cparm('FELNTH', 0.015)
bhl.config.set_cparm('ART_SYNCH', 200)
bhl.config.set_cparm('const_inj', 1.0e3)
bhl.config.set_cparm('SKIP_ADIAB', False)
bhl.config.set_cparm('SKIP_VISCOUS', False)
bhl.config.set_cparm('SKIP_COOLING', True)
bhl.config.set_cparm('CONST_INJECTION', False)
