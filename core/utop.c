...
int Utoprim(double U[NVAR], struct of_geom *geom, double prim[NVAR]) {
  ...
  double lapse, detg, Bsq, D, Ep, QdB, Qtsq, Qsq, Qdotn, rho0, u, gamma, Wp, Wp1, W, w, P, err, err1, dW;

  // defint function used //
  double err_eqn(double Bsq, double D, double Ep, double QdB, double Qtsq, double Wp, struct of_geom *geom, double *extra, int *eflag);
...
/********************************************************************************/
/* wp function, part of the primitive finding */
double Wp_func(double *prim, struct of_geom *geom, int *eflag) {
