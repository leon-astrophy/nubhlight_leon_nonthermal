...
// core //
static double EOS_SC_interp( const double lrho, const double lT, const double Ye, double *restrict tab);
...
static double interp_2d(const double lrho, const double Ye, const double *tab_2d);
static void temp_map(double lrho, double Ye, const double *tab);
static double catch_var_2d(const double lrho, const double Ye, const double var, const double *tab_min_2d, const double *tab_max_2d);
static double catch_var_2d_monotone( const double lrho, const double Ye, const double var, double *restrict tab);

// Root finding //
static int  find_lT(const double lrho, double lTguess, const double ye, double *restrict tab, const double val, double *lT);
static void adiabat_lrho_min_max(double s, double ye, double *lrho_min, double *lrho_max);
static int find_adiabat_0d(double lrho, double lTguess, double ye, double s, double *lT);
...
// fix borked tables //
#if DO_SMOOTH
void fill_mdn_buffer(double buffer[], int width, int iYe, int iT, int irho, double *restrict tab);
