...
#if NONTHERMAL
/*!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!*/
double nteGammas[NTEBINS];      // Lorentz factor
double log10nteGammas[NTEBINS]; // log of Lorentz
double log10BinSpace;           // bin width in log10
double logeBinSpace;            // bin width in natural log
/*!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!*/
#endif
...
#if NONTHERMAL
/*!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!*/
double normterm;     // normalization
double powlaw_int;   // power-law integral
double gammainjmin;  // lower injection limit
double gammainjmax;  // maximum injection limit
/*!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!*/
#endif
