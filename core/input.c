...
/****************************************************************/
/* given parameter name, set its value */
...
/****************************************************************/
/* given parameter name, get its value  */
...
void set_core_params() {
  ...
  #if NONTHERMAL
  /* range of gamma for nonthermal electrons */
  /* read from parameter files and set the value */
  /*!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!*/
  ...
  // flag for whether initializing from GRMHD //
