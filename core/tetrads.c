...
/*************************************************************************************/
// given 4-vector in tetrad frame, transform to that of the coordinate frame // 
...
// make a tetrad transformation matrix //
void make_tetrad(int i, int j, int k, double Ucon[NDIM], double trial[NDIM], double Gcov[NDIM][NDIM], double Econ[NDIM][NDIM], double Ecov[NDIM][NDIM]) {
  ...
  if (norm > SMALL_VECTOR) {
    ...
    if (X1ness > X2ness && X1ness > X3ness) {
      ...
      // Trial vector is closest to X3. Overwrite //
...
/*************************************************************************************/
/* normalize a null vector, covariatn component */
