...
void init_mpi() {
  ...
  #if RADIATION
  /*@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@*/
  // check for inconsistent boundary conditions //
...
/**************************************************************************/
/* copy to ghost cells across MPI processes */
...
/******************************************************************/
/* get number of MPI process */
int mpi_nprocs() { 
  return numprocs; 
}

/******************************************************************/
/* maximum across MPI process */
...
void mpi_reduce_nuLnu() {
  MPI_Reduce(nuLnu, nuLnu_local, (NULNU_IDX0)*NTH * NPHI * NU_BINS_SPEC, MPI_DOUBLE, MPI_SUM, 0, comm);
  memcpy(nuLnu, nuLnu_local, (NULNU_IDX0)*NTH * NPHI * NU_BINS_SPEC * sizeof(double));
}
/*@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@*/
#endif // RADIATION
